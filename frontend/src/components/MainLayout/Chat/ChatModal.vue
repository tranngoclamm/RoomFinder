<template>
  <div class="chat-modal-wrapper">
    <div @click='setMessageChatState(true), setMessageDetailState(false), setConversationState(true)' v-if="isMessageIcon" class="icon-message-chat">
      <svg class="icon-chat" width="60px" height="60px" viewBox="0 0 60 60" cursor="pointer"><svg x="0" y="0" width="60px" height="60px"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g><circle fill="#0A7CFF" cx="30" cy="30" r="30"></circle><svg x="10" y="10"><g transform="translate(0.000000, -10.000000)" fill="#FFFFFF"><g id="logo" transform="translate(0.000000, 10.000000)"><path d="M20,0 C31.2666,0 40,8.2528 40,19.4 C40,30.5472 31.2666,38.8 20,38.8 C17.9763,38.8 16.0348,38.5327 14.2106,38.0311 C13.856,37.9335 13.4789,37.9612 13.1424,38.1098 L9.1727,39.8621 C8.1343,40.3205 6.9621,39.5819 6.9273,38.4474 L6.8184,34.8894 C6.805,34.4513 6.6078,34.0414 6.2811,33.7492 C2.3896,30.2691 0,25.2307 0,19.4 C0,8.2528 8.7334,0 20,0 Z M7.99009,25.07344 C7.42629,25.96794 8.52579,26.97594 9.36809,26.33674 L15.67879,21.54734 C16.10569,21.22334 16.69559,21.22164 17.12429,21.54314 L21.79709,25.04774 C23.19919,26.09944 25.20039,25.73014 26.13499,24.24744 L32.00999,14.92654 C32.57369,14.03204 31.47419,13.02404 30.63189,13.66324 L24.32119,18.45264 C23.89429,18.77664 23.30439,18.77834 22.87569,18.45674 L18.20299,14.95224 C16.80079,13.90064 14.79959,14.26984 13.86509,15.75264 L7.99009,25.07344 Z"></path></g></g></svg></g></g></svg></svg>
    </div>
        ...
        <div class="ks-discussions h-100">
            <div class="ks-search">
                <div class="input-icon icon-right icon icon-lg icon-color-primary mt-0">
                    ...
                    <i @click="setConversationState(false), isMessageIcon = true" class="fa-solid fa-angles-down cursor-pointer"></i>
                    <hr>
                </div>
            </div>
            <div class="ks-body ks-scrollable jspScrollable" data-auto-height="" style="height: 400px; overflow-y: auto; padding: 0px; width: 339px;" tabindex="0">
                ...
                <div class="jspContainer" style="width: 339px; height: 550px;">
                    <div class="jspPane" style="padding: 0px; top: 0px; ">
                        <ul class="ks-items">
                          <li @click="openMessageDetail(conversation._id)" v-for="conversation in conversations" :key="conversation._id" 
                              :class="{'ks-item': true, 'ks-unread': hasUnreadMessages(conversation)}">
                            <a href="#">
                              <span class="ks-avatar">
                                <img :src=" getAvatar(conversation)  || 'https://res.cloudinary.com/dlawgdb8h/image/upload/v1730344959/avatars/kn6xdlvb6hivqkhka000.jpg'" width="36" height="36">
        ...
        <div class="d-flex justify-content-center h-100" style="width:fit-content;">
          <div class="col-12 p-0 position-relative chat-wrapper">
            <div class="card h-100" id="chat2">
              <div class="card-header d-flex justify-content-between align-items-center p-3">
                <div class="d-flex">
                  <div class="" style="width: 18px">
                    <i v-if="!this.isConversation" @click="setConversationState(true)" class="fa-solid fa-angles-left cursor-pointer"></i>
                  </div>
              ...
              <div class="card-body" data-mdb-perfect-scrollbar-init style="position: relative; height: 400px; width: 400px">
                <!-- Profile Receiver Information -->
                <div v-if="messages.length === 0" class="profile-receiver d-flex justify-content-center align-items-center flex-column">
                ...
                <template v-else v-for="group in groupedMessages" :key="group.senderId + group.date">
                  ...
                  <!-- Messages Group -->
                  <div class="d-flex" :class="{ 'justify-content-end': group.senderId != userProfile._id, 'justify-content-start': group.senderId == userProfile._id }">
                    <!-- Avatar (only displayed once per group) -->
                    <img v-if="group.senderId == userProfile._id" :src="userProfile.profilePicture" class="rounded-circle" alt="avatar" style="width: 45px; height: 100%;" />
                    ...
                    <div>
                      ...
                      <p v-if="group.messages.length>1" class="small text-muted d-flex" :class="{ 'justify-content-end me-4': group.senderId != userProfile._id, 'justify-content-start ms-4': group.senderId == userProfile._id }">
                    ...
                    <img v-if="group.senderId !== userProfile._id" :src="group.senderProfilePicture" class="rounded-circle" alt="avatar" style="width: 45px; height: 100%;" />
                  </div>
                </template>
              ...
              <div class="card-footer text-muted p-0">
                <div class="d-flex justify-content-start align-items-center p-3">
                  <div class="image__preview-wrapper">
                    <img src="https://res.cloudinary.com/dlawgdb8h/image/upload/v1730544781/q9ia3fooudmscnjoxd79.jpg" class="image-preview" alt="">
                    <i class="fa-solid fa-x cursor-pointer"></i>
                  </div>
                  <!-- <img class="rounded-circle" :src="userProfile.profilePicture || 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp'"
                    alt="avatar 3" style="width: 40px; height: 100%;"> -->
                  <input type="text" spellcheck="false" class="form-control form-control-lg" id="exampleFormControlInput1"
  ...
  // createConversation,
   getUserConversations,
    ...
    export default {
        name: 'ChatModal',
        computed: {
          ...mapGetters(['getChatUser', 'getUserProfile', 'getMessageChatState', 'getMessageDetailState', 'getConversationState']), 
          chatUser() {
          ...
          groupedMessages() {
            ...
            this.reversedMessages.forEach((message) => {
              ...
              if (!currentGroup || currentGroup.senderId !== message.sender._id || currentDate !== date) {
                ...
                currentGroup.messages.push({ ...message, time });
              });
        ...
        methods: {
          ...mapMutations(['setUserProfile', 'setMessageDetailState', 'setMessageChatState', 'setConversationState']),
                  ...
                  console.log(this.userProfile)
                    ...
                    if (response && response.data.conversations) {
                        ...
                        conversations.forEach(newsItem => {
                            ...
                            console.log(messageDate.fromNow());
          ...
          async fetchMessageDetail(conversationId) {
                try {
                  console.log(this.userProfile)
                    const response = await getMessages(conversationId, 1, ''); // Gọi hàm API với page = 1
                    console.log(response.data)
                    if (response && response.data.messages) {
                        let messages = response.data.messages
                        messages.forEach(newsItem => {
                            const messageDate = dayjs(newsItem.lastMessageAt);
                            console.log(messageDate.fromNow());
                            newsItem.relativeTime = messageDate; // chuyển định dạng ngày
                        });
          ...
          openMessageDetail(conversationId){
              this.fetchMessageDetail(conversationId)
          ...
          getAvatar(conversation) {
            ...
            return otherParticipant ? otherParticipant.profilePicture : 'https://res.cloudinary.com/dlawgdb8h/image/upload/v1730344959/avatars/kn6xdlvb6hivqkhka000.jpg';
          },

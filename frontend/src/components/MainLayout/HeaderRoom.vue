        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
          ...
          <div class="lang__currency lang_top d-block d-sm-none">
            <div class="dropdown white">
              <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="dropdownMenuLang">
          ...
          <button class="navbar-toggler header__hamburger-wrap" type="button">
            <div class="hamburger-icon" @click="hamburgerMenu('logo_white')" :class="{ open: hamburger_menu }">
              <span></span>
              <span></span>
              <span></span>
              <span></span>
          ...
          <transition name="fade">
            <div :class="{'d-block':hamburger_menu}" class="header__navbar-collapse-mobile collapse navbar-collapse"
              id="navbarText">
              <div class="header__navbar-collapse-mobile-wrap navbar-collapse">
                <ul class="navbar-nav mx-auto ps-2">
                  ...
                  <li class="nav-item">
                    <div class="calltoaction__text" @mouseover="animation.phone = true"
                      @mouseleave="animation.phone = false">
                      <router-link to="/favorites">
                        <div v-bind:class="{ 'shake animated slow infinite': animation.phone }"
                  ...
                  <div class="calltoaction ms-1">
                    <div class="login-nav">
                      ...
                      <div v-if="lastName" class="avatar ms-2 d-flex align-items-center jutify-content-center">
                        <img class="dropdown-toggle hover" role="button" data-bs-toggle="dropdown" aria-expanded="false"
                          src="@/assets/images/default-user.svg" alt="avatar">
                ...
                <div class="header__navbar-socials-mobile">
                  <ul class="list-inline hero__footer__social">
                    <li class="list-inline-item">
                      <a href="https://www.facebook.com/rentroom.md/" target="_blank">facebook</a>
                    </li>
                    <li class="list-inline-item">
                      <a href="https://www.instagram.com/rentroom.md/" target="_blank">instagram</a>
                    </li>
                    <li class="list-inline-item">
                      <a href="https://m.me/rentroom.md" target="_blank">messenger</a>
                    </li>
                    <li class="list-inline-item">
                      <a href="viber://chat?number=37378242428" target="_blank">viber</a>
                    </li>
                    <li class="list-inline-item">
                      <a href="https://wa.me/37378242428" target="_blank">whatsapp</a>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-12 col-lg-3">
                    <div class="booking__form__block__el brd_right user-select-none">
                      ...
                      <div class="booking__form__block__el__input">
                        <div data-v-7e7894dc="" class="dropdown"
                          style="--options-height: 35px; --options-height-neg: -35px; --option-height: 35px; --main-el-border-radius: 0; --dropdown-width: 180px; --dropdown-background-color: #cde4f5; --dropdown-expanded-color: #fff; --dropdown-border: 1px solid gray; --dropdown-hover-background-color: #0084d4; --dropdown-default-text-color: black;">
                          <div data-v-7e7894dc="" class="dropdown-label-container">
                            <div data-v-7e7894dc="" class="dropdown-label" ref="dropdownRoom"
                              @click="toggleDropdown('room')">
                              <span data-v-7e7894dc="" class="text">{{ selectedRoomType }}</span>
                              <i data-v-7e7894dc="" class="angle-down"></i>
                            </div>
                            <div v-if="isDropdownOpenTypeRoom" class="dropdown-menu pb-0"
                              style="width: 108% !important">
                    ...
                    <div class="booking__form__block__el brd_right user-select-none">
                      ...
                      <div class="dropdown ms-0 w-100 mt-1">
                        <div class="d-flex align-items-center">
                          <input type="text" spellcheck="false" placeholder="Nhập khu vực" v-model="inputsearchLocation"
                            @input="searchLocation"
                            class="d-flex align-items-center location-input w-100 dpicker__input" />
                          <i class="angle-down ms-4"></i>
                        </div>
                        <div class="dropdown ms-2">
                          <ul class="dropdown-menu location-menu d-block"
                            v-if="isDropdownAreaVisible && inputsearchLocation.length > 1">
                  ...
                  <div class="col-12 pe-0 col-lg-2 brd_right">
                    <div class="booking__form__block__el user-select-none">
                      ...
                      <div class="dropdown ms-2 w-100">
                        <span @click="toggleDropdown('price')" data-v-78fbf3d8=""
                          class="d-flex  hover align-items-center w-100 dpicker__input">
                          {{ priceDisplay }}
                  ...
                  <div class="col-12 pe-0 col-lg-2 brd_right user-select-none">
                    <div class="booking__form__block__el">
                      ...
                      <div class="dropdown ms-2 w-100">
                        <span @click="toggleDropdown('area')" data-v-78fbf3d8=""
                          class="d-flex  hover align-items-center w-100 dpicker__input">
                          {{areaDisplay}}
                          <i data-v-78fbf3d8="" class="angle-down ms-4"></i>
                        </span>
                  ...
                  <div class="col-12 col-lg-2">
                    <div class="booking__form__block__el">
                      <div class="btn__submit__wrap">
                        <button type="submit" @click.prevent="searchRoom" @click="emitScrollToLatestPost"
                          class="search_btn">Tìm</button>
                      </div>
                    </div>
                  </div>
                </div>
...
<script>
  ...
  export default {
    name: 'HeaderRoom',
    emits: ['openPostModal', 'search', 'scroll-to-title', 'scroll-to-latestPostTitle',
    'scrollToLatestPostTitle'], // Khai báo sự kiện
    components: {
      PostNewModal,
      ChatModal
    },
